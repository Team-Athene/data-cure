...
<template>
  ...
  <div v-if="type === 'register'">
    <ABtn class="rounded-full w-72 mt-4 mb-6 font-bold" v-if="!isConnected" color="primary" @click="connect()">
    ...
    <ABtn v-else class="rounded-full w-72 mt-4 mb-6 font-bold" color="warning" @click="connect()">
